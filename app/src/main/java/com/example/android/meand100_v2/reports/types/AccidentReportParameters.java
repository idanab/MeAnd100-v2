...
public class AccidentReportParameters extends ReportParameters {
    public AccidentReportParameters(Context context) {
        super(context);
        FIRST_QUESTION = context.getResources().getString(R.string.accident_is_disturbing);
        ...
        possibleSecondAnswersArray.add(context.getResources().getString(R.string.accident_type_roll_over));
